...
<div class="container-fluid">
    <div class="card">
        <div class="card-header"><h4>📸 Tambah Customer (Foto disimpan sebagai Blob)</h4></div>
        <div class="card-body">
            ...
            <div class="mb-3 text-center">
                <button type="button" id="btn-kamera" class="btn btn-info">
                    📷 Buka Kamera
                </button>
                <button type="button" id="btn-foto" class="btn btn-warning" style="display:none;">
                    📸 Ambil Foto
                </button>
                <button type="button" id="btn-ulang" class="btn btn-secondary" style="display:none;">
                    🔄 Ulangi
                </button>
            </div>

            <form action="{{ route('user.customer.simpan1') }}" method="POST" id="formCustomer1">
                @csrf
